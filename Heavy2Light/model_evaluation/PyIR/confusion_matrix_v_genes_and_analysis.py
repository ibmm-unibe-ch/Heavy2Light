...
def generate_confusion_matrix(df: pd.DataFrame, true_col: str, gen_col: str, 
    ...
    # Add family rectangles if requested
    ...
    plt.title(f'Confusion Matrix (V Gene Family Ordered)\nAccuracy: {accuracy:.3f} ({accuracy*100:.1f}%)', 
...
def main(true_col: str = 'true_v_gene_simple', gen_col: str = 'gen_v_gene_simple',
         ...
         show_family_rectangles: bool = False):
    """
    ...
    Args:
        ...
        show_family_rectangles: Whether to show colored rectangles around family groups
    """
    ...
    confusion_matrix_save_path = "/ibmm_data2/oas_database/paired_lea_tmp/paired_model/unconditioned_gen_seqs/PyIR/confusion_matrix_outputs/no_rect_family_confusion_matrix.png"  
    ...
    cm, labels, accuracy = generate_confusion_matrix(df, true_col, gen_col, 
                                                        ...
                                                        show_family_rectangles=show_family_rectangles)
    ...
    analyze_vgene_vs_similarity(df, f"{output_path}/no_rect_family_analysis.png", true_col, gen_col, summary_figsize)
        
    print("\nAnalyzing Similarity Distributions...")
    create_similarity_distribution_plot(df, f"{output_path}/no_rect_family_similarity_distribution.png", true_col, gen_col)
