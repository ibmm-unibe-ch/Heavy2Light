...
#     """
#     Plot dimensionality reduction results using a seaborn-like style with optional line histograms
...
#         # Determine the figure size based on whether we're showing marginals
#         if show_marginals:
...
#             scatter.set_xlabel("Component 1", fontsize=16)
#             scatter.set_ylabel("Component 2", fontsize=16)
#             scatter.tick_params(axis='both', which='major', labelsize=12)
            
#             # # Plot line histograms on the marginals
#             # if show_marginals:
#             #     # Plot the marginal histograms for each label
#             #     for label in unique_labels:
#             #         mask = result_df['Label'] == label
#             #         # Get label's color from the scatter plot
#             #         color = palette[unique_labels.index(label)]
                    
#             #         # Plot line representation of histograms
#             #         plot_histogram_line(g.ax_marg_x, result_df.loc[mask, "Component 1"], color)
#             #         plot_histogram_line(g.ax_marg_y, result_df.loc[mask, "Component 2"], color, vertical=True)

#             # Plot bar histograms on the marginals
#             # Plot unfilled histograms on the marginals with matching colors
#             if show_marginals:
...
#                 # Create a color dictionary mapping labels to colors
...
#                 # Adjust the appearance of the marginal plots
...
#             markerscale=2.0,              # Make the markers in the legend 2x larger
#             loc='lower center',
#             bbox_to_anchor=(1, 0.5),    # Moved slightly to the right to accommodate larger legend
#             frameon=False,
#             handlelength=2.5,             # Increase the length of the legend handles
#             handleheight=1.5,             # Increase the height of the legend handles
#             borderpad=1.0,                # Add padding around legend content
...
#         else:
#             # Create a regular plot without marginals
...
#         plt.savefig(output_file, dpi=400, bbox_inches='tight', format="svg")
...
plot_save_prefix = "TEST_v_gene_heavy_family_improved_v2_font_size_16"
